...
function Oregon() {
  return (
    <div className="oregon">
      <Link className="oregon__back-link" to="/">
        <img className="oregon__back-btn" src={backBtn} alt="return-btn" />
      </Link>
      <div className="oregon__img-wrapper">
        <img className="oregon__img" src={or3} alt="or3" />
        <img className="oregon__img" src={or5} alt="or5" />
        <img className="oregon__img" src={or1} alt="or1" />
        <img className="oregon__img" src={or8} alt="or8" />
        <img className="oregon__img" src={or9} alt="or9" />
        <img className="oregon__img" src={or7} alt="or7" />
        <img className="oregon__img" src={or6} alt="or6" />
        <img className="oregon__img" src={or10} alt="or10" />
        <img className="oregon__img" src={or2} alt="or2" />
      </div>
    </div>
  );
}
